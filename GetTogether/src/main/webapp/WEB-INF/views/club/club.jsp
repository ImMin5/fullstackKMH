...
<script>
	...
	$(document).ready(function(){
		...
		$(document).on('click',"#list_map_btn",function(){
			location.href="${url}/main/club_info/${cvo.no}";
		...
		$(document).on("click", "#write_btn", function(){
			location.href='${url}/main/club/review_form';
		})
		<!-- 검색 기능-->
			...
			<div class="col-8">
				...
				<div id="info_section" class="table-responsive">
					<table id="info_section_table" class="table">
					  ...
					  <tbody>
					    <tr >
					      <th scope="row"  onclick="location.href='review.html'" >1</th>
					      <td  onclick="location.href='review.html'" >수제버거 패티가 정말 맛있는 집1</td>
					      <td  onclick="location.href='review.html'" >양재동 111길 11-1 수제버거</td>
					      <td  onclick="location.href='review.html'">4.6</td>
					      <td  onclick="location.href='review.html'">2022.02.01</td>
					      <td  onclick="location.href='review.html'">gildong1234</td>
					      <td  onclick="location.href='review.html'">2020.02.11</td>
					    </tr>
